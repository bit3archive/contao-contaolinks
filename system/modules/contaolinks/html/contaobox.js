...
var Contaobox = {
	...
	fillModeList : function(id) {
		...
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('contaolinks_dlg.image_crop'), 'crop');
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('contaolinks_dlg.image_proportional'), 'proportional');
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('contaolinks_dlg.image_box'), 'box');
	},
...
Contaobox.preInit();
tinyMCEPopup.onInit.add(Contaobox.init, Contaobox);
